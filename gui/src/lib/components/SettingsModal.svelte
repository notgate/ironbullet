...
{ section: 'paths', label: 'Collections Folder', keywords: 'collections configs folder path' },
        ...
        { section: 'paths', label: 'Chrome Executable', keywords: 'chrome chromium browser executable path' },
        { section: 'paths', label: 'Configs Directory', keywords: 'configs rfx opk svb save default path folder' },
        { section: 'paths', label: 'Results Directory', keywords: 'results output hits save default path folder' },
